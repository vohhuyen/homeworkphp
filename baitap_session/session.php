...
if (!($_COOKIE["khachhang"])) {
  $khachhang = $_POST["ho_ten"].' - '.$_POST["email"] . ' - '.$_POST["ten_dn"].' - '.$_POST["mat_khau"];
  setcookie("khachhang", $khachhang, time() + 3600);
}
}
?>
...
<form id="form2" name="form2" method="post" action="">
  <?php
 	if($flag==1)
	{
		...
		echo "<a href='doc_session.php'>Click here to go to the session page!</a></br>";
    echo "<a href='doc_cookie.php'>Click here to go to the cookie page!</a>";
		echo "</td></tr></table>";
		}
 ?>
</form>
